<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConfigurePayment.ascx.cs" Inherits="Geta.EPi.Commerce.Payments.Klarna.Checkout.Framework.Apps.Order.Payments.Plugins.KlarnaCheckout.ConfigurePayment" %>
