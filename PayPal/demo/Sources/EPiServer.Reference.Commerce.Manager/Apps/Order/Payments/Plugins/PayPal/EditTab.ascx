<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditTab.ascx.cs" Inherits="Geta.Commerce.Payments.PayPal.Manager.Apps.Order.Payments.Plugins.PayPal.EditTab" %>
<div id="DataForm">
