<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConfigurePayment.ascx.cs" Inherits="Geta.Commerce.Payments.PayPal.Manager.Apps.Order.Payments.Plugins.PayPal.ConfigurePayment" %>
<div id="DataForm">
        ...
        <tr>
            ...
            <td class="FormFieldCell">
                ...
                <asp:RequiredFieldValidator ControlToValidate="SuccessUrl" Display="dynamic" Font-Name="verdana" Font-Size="9pt"
                                            ErrorMessage="SuccessUrl required" runat="server" id="Requiredfieldvalidator6"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td colspan="2" class="FormSpacerCell"></td>
        ...
        <tr>
            ...
            <td class="FormFieldCell">
                ...
                <asp:RequiredFieldValidator ControlToValidate="CancelUrl" Display="dynamic" Font-Name="verdana" Font-Size="9pt"
                                            ErrorMessage="CancelUrl URL required" runat="server" id="Requiredfieldvalidator7"></asp:RequiredFieldValidator>
            </td>
        </tr>
    </table>
</div>