...
namespace Geta.Resurs.Checkout
{
    ...
    {
        public static readonly IDictionary<string, string> ThreeLetterCountryCodeMappings = new Dictionary<string, string>(StringComparer.InvariantCultureIgnoreCase) {
               { "AFG", "AF" },    // Afghanistan
               { "ALB", "AL" },    // Albania
               { "ARE", "AE" },    // U.A.E.
               { "ARG", "AR" },    // Argentina
